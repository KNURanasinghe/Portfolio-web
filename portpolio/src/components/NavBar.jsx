  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full bg-opacity-70 backdrop-blur-md'>
      <div className='max-w-[1300px] mx-auto flex justify-between text-gray-200 text-xl items-center px-12 h-20'>
        ...
        <a href='#' className='text-2xl font-bold'>K.N.U.Ranasinghe</a>

        <ul className='hidden gap-12 cursor-pointer md:flex'>
          <li><Link to="skills" smooth={true} offset={-70} duration={500}>About</Link></li>
          <li><Link to="portfolio" smooth={true} offset={-70} duration={500}>Portfolio</Link></li>
        ...
        >
          <ul className='mt-24 space-y-8 text-4xl font-semibold text-center'>
            ...
            <li><Link to="portfolio" onClick={closeNav} smooth={true} offset={-70} duration={500}>Portfolio</Link></li>
